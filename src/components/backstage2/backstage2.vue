<template>
  <div class="backstage">
    <Layout>
      <Header>
        <div class="logo">明心数字小程序管理后台</div>
        <div class="right">
          <div class="lang msg">
    ...
    return {
      ...
      menus: [
        ...
        },
        {
          mark: "1-2",
          name: "订单管理",
          url: "/backstage/dingdanList"
        },
        {
          mark: "1-3",
          name: "活动编辑",
          url: "/backstage/activeBj"
        },
        {
          mark: "1-4",
          name: "明心数字",
          url: "/backstage/mxinshuzi"
        },
        {
          mark: "1-5",
          name: "解析报告",
          url: "/backstage/jiandanjiexi",
          children:[
            {
              mark:"1-5-1",
              name:"简单解析",
